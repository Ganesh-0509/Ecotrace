...
const monthDocRef = (uid: string, monthKey: string) =>
...
export const firestoreTrackingRepo: TrackingRepo = {
  ...
  async getMonthLog(uid, monthKey) {
    ...
    return snap.exists() ? (snap.data() as MonthLog) : emptyMonth(monthKey);
  },
