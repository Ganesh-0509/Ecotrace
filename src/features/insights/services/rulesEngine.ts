...
const CATEGORY_INTENSITY: Record<string, (p?: ProfileLike) => number> = {
...
const RECOMMENDATIONS: Record<string, (p?: ProfileLike) => Recommendation> = {
...
function city(profile?: ProfileLike): string {
...
export function generateRuleInsights(
  profile: ProfileLike = {},
  monthLog: Partial<MonthLog> | null = {}
): Insight[] {
