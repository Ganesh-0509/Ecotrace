...
import { MICRO_ACTIONS, ACTION_CATEGORIES, type MicroAction } from '../../../utils/emissionFactors';
...
interface ActionLoggerProps {
  onLog: (actionId: string) => Promise<LogEntry | undefined>;
  logging: boolean;
}

export default function ActionLogger({ onLog, logging }: ActionLoggerProps) {
  ...
  const handleLog = async (action: MicroAction) => {
